...
class UsuariosM extends ConexionBD{
	...
	static public function GuardarDatosM($tablaBD, $datosC){
		...
		$pdo = ConexionBD::cBD()->prepare("UPDATE $tablaBD SET usuario = :usuario, clave = :clave, nombre = :nombre, apellido = :apellido, documento = :documento, telefono = :telefono, direccion = :direccion, foto = :foto WHERE id = :id");
	...
	static public function EditarUsuarioM($tablaBD, $datosC){

		$pdo = ConexionBD::cBD()->prepare("UPDATE $tablaBD SET usuario = :usuario, clave = :clave, nombre = :nombre, apellido = :apellido, rol = :rol WHERE id = :id");
